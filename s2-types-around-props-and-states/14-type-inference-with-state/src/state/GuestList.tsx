...
const GuestList: React.FC = () => {
  ...
  // Take the current array of guests, take all the different strings out of it, add it to an new array, and then add it to a new array, and then add on name to the very end.
  const onClick = () => {
    setName('');
