...
/**************************************************************************************
3. Variable whose type cannot be inferred correctly as TS don't understand the intent 
of our code. Then is when we want to annotation our variable. 
Assign an array of three number elements to the number variable. This will store the 
array inside the variable we just declared with the let keyword since the variable will 
change over time to different numbs. 
Now we can assign either a boolean or a number type to the numberAboveZero variable.
**************************************************************************************/
let numbers = [ -10, -1, 12 ];
let numberAboveZero: boolean | number = false;
// Execute the code in the body of the for-loop whenever the condition within the loop evaluates to true.
// Whenever the lenghth of the numbers variable is less than the value of the i variable, then increment it up by 1.
