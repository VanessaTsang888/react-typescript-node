/* 
If I declare apples variable with let rather than const then I can re-assign the variable to a different number late.
*/
...
/* 
re-assign to a different number. If I try to assign this variable a different type of value such as a String 
I'll get an error which is what I should expect.
*/
...
/* 
If I try to assign this variable a different type of value such as a Number then TS will throw an error by under lining the
...
Built in Objects. We declare a variable that can ONLY have a type of Date and we going to assign it an instance of a date Object.
*/
...
We can only assign an Object to point that has an x property that's a number type, and an y property that's a number type as well.
*/
