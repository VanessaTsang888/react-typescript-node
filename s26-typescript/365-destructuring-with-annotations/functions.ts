...
// Take today's date and just logout today's weather.
// Pass-in an Object literal. Mark the return type as void since we not going to return anything.
...
// With destructuring: replace the forecast object that's in the parenthises with a set of braces
// and list out a list of objects I want to pull out from object. Then adject body to just date and weather.
